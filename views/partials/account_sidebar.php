        ...
        <div class="col-lg-3 col-md-4">
            <div class="sidebar account-sidebar">
                ...
                <div class="nav flex-column">
                    ...
                    <span class="nav-link d-flex align-items-center text-muted user-select-none" style="pointer-events: none; cursor: default;" title="<?= htmlspecialchars(__m('account_sidebar.nav_coupons_title'), ENT_QUOTES, 'UTF-8') ?>"><i class="bi bi-ticket-perforated me-2"></i> <?= htmlspecialchars(__m('account_sidebar.nav_coupons'), ENT_QUOTES, 'UTF-8') ?></span>
