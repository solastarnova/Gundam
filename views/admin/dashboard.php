    ...
    <div class="col-md-6 mb-4">
        <div class="content-card">
            ...
            <?php if (empty($recentOrders)): ?>
                <p class="text-muted text-center py-3">暫無訂單</p>
            <?php else: ?>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($money((float) $order['total_amount']), ENT_QUOTES, 'UTF-8') ?></td>
                                <td>
                                    <?php
                                    $statusClass = [
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= $url('admin/products/edit/' . $product['id']) ?>" 
                                       class="btn btn-sm btn-warning">補貨</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
